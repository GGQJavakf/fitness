...
describe('repository verification entry', () => {
  ...
  it('composes frontend API drift, type, tests, build, preflight and backend verify', () => {
    ...
    expect(steps[2].executable).toBe('sh')
    expect(steps[2].arguments).toEqual(['./mvnw', 'clean', 'verify'])
    expect(steps[2].unsetEnvironment).toEqual(releaseKeys)
    expect(steps[3].executable).toBe(process.execPath)
    expect(steps[3].arguments[0]).toMatch(/audit-maven-runtime-osv\.mjs$/)
