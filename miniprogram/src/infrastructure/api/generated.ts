...
export type SyncOperationResult = components['schemas']['SyncOperationResult']
export type SyncConflict = components['schemas']['SyncConflictData']
export type ResolveSyncConflictRequest = components['schemas']['ResolveSyncConflictRequest']
